        ...
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Commercial <span className="gradient-text">Properties</span>
            </h1>
            <p className="text-lg text-gray-400 mb-12 max-w-3xl">
              Discover premium commercial real estate investment opportunities. Our portfolio includes office buildings, retail spaces, and mixed-use developments designed to generate stable cash flow and appreciate in value over time.
            </p>
              ...
              {properties.map((property) => (
                <div key={property.id} className="glass-card group cursor-pointer overflow-hidden">
                  <div className="relative aspect-video mb-4 rounded-lg overflow-hidden">
                    <Image
                      src={`https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop&sig=${property.id}`}
                      alt={property.title}
                      fill
