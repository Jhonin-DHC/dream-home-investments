...
export default function ResidentialInvestmentPage() {
  const properties = Array.from({ length: 6 }, (_, i) => ({
    id: i + 1,
    title: `Residential Property ${i + 1}`,
        ...
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Residential <span className="gradient-text">Investment</span>
            </h1>
            <p className="text-lg text-gray-400 mb-12 max-w-3xl">
              Explore our curated selection of residential investment properties. From single-family homes to townhouses, we offer diverse opportunities for building your real estate portfolio with properties that deliver strong returns and long-term value.
            </p>
              ...
              {properties.map((property) => (
                <div key={property.id} className="glass-card group cursor-pointer overflow-hidden">
                  <div className="relative aspect-video mb-4 rounded-lg overflow-hidden">
                    <Image
                      src={`https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&h=600&fit=crop&sig=${property.id}`}
                      alt={property.title}
                      fill
